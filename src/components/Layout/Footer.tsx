      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-1">
            ...
            <div className="inline-flex items-center space-x-2 bg-gradient-to-r from-purple-600 to-blue-600 px-3 py-2 rounded-full text-sm">
              <ExternalLink size={14} />
              <span className="font-medium">{t('built_with_bolt')}</span>
            </div>
          </div>
        ...
        <div className="border-t border-gray-700 mt-8 pt-8">
          ...
          <div className="mt-6 text-center text-gray-400 text-xs space-y-2">
            <p>
              <strong>Disclaimer:</strong> Reserve Bank of India is not liable and does not accept any responsibility for the correctness of any of the statements or representations made or opinions expressed by Vibe, and does not assure of repayments of the loans lent on it.
            </p>
            <p>
              Vibe is an Intermediary under the provisions of the Information Technology Act, 1999 and virtually connects lenders and borrowers through its website and mobile applications. The loan transaction is between lenders and borrowers at their own discretion and Vibe is neither party to the transaction nor does it provide any assurance or guarantee of loan disbursement to borrowers or returns to the lenders.
            </p>
            <p>
              <strong>RBI Registration:</strong> The Company is having a valid Certificate of Registration dated March 1, 2021 issued by the Reserve Bank of India under section 45 IA of the Reserve Bank of India Act, 1934. RBI COR No: N.13-02409 dated 01/03/2021
            </p>
